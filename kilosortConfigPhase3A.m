...
ops.fbinary             = '[set this path]\c45_npx_raw_flipped_CAR.bin'; % will be created for 'openEphys'		
ops.fproc               = '[set this path]\temp_wh.dat'; % residual from RAM of preprocessed data		
ops.root                = '[set this path]'; % 'openEphys' only: where raw files are		
		
ops.fs                  = 30000;        % sampling rate		(omit if already in chanMap file)
ops.NchanTOT            = 384;           % total number of channels (omit if already in chanMap file)
ops.Nchan               = 374;           % number of active channels (omit if already in chanMap file)
...
ops.chanMap             = '[set this path]\github\neuropixels\neuropixPhase3A_kilosortChanMap.mat'; % make this file using createChannelMapFile.m		
